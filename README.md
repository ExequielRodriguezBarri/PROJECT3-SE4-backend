...
```
git clone https://github.com/ExequielRodriguezBarri/PROJECT3-SE4-backend.git
```
...
3. Configure **Apache** to point to **Node** for API requests.
    ...
    ```
    ProxyPass /resume-t7 http://localhost:3027/resume-t7
...
4. Make a local **resume** database.
